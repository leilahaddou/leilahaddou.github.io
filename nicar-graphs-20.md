...
In this session, we'll build a basic political donation graph using UK political donations to current British Prime Minister Boris Johnson from January 2019 to January 2018.
